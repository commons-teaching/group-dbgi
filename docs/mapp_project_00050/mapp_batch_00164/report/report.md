...
## Conclusion
In conclusion, we were able to extract  nd to analyze metabolites coming from the three different plant species. This means that the procedure is working and applyable to extract compounds from the leaves of plants. We were able to find some compounds that we expected to see, like cocaine and also the cardiotoxin produced by Strophantus. However, we were not able to find rotenone produced by _Derris Helliptica_, as it is known to accumulate in the roots of the plant and not in its leaves. However, we were also able to identify clusters with features from a single plant as well as shared clusters. 
We were also positively amazed to find molecules that probably were not produced by plants. In fact, a molecule was found that came from bacteria that were likely used to protect plants in the botanical garden.   
